...
github-mcp-server-actions_list with method="list_workflow_runs", owner="StanislavMakhrov", repo="placeholder", perPage=5
github-mcp-server-get_job_logs with owner="StanislavMakhrov", repo="<placeholder>", job_id=<job-id>
